...
import com.app.ismart.adopters.BackdoorCategoryAdopter;
import com.app.ismart.api.IApiCalls;
import com.app.ismart.databinding.FragmentBackdoorcategoryBinding;
...
public class FragmentBackdoorCategories extends Fragment implements IRestResponseListner<List<ItemDto>> {
    public ShopDto shopDto;
    static FragmentBackdoorcategoryBinding layoutBinding;
    ...
    BackdoorQuantityRepository quantityrepository;
    String date;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layoutBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_backdoorcategory, container, false);
        ...
        quantityrepository = new BackdoorQuantityRepository(realmController.getRealm());
    ...
    public void setAdopter(List<ItemDto> list) {
        ...
        BackdoorCategoryAdopter adapter = new BackdoorCategoryAdopter(expandableListTitle, getContext(), expandableListDetail, shopDto);
